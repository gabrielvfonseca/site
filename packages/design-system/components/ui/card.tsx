...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-modal text-modal-foreground flex flex-col gap-6 rounded-xl border border-modal-border py-6",
        className
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("leading-none text-primary-foreground font-semibold", className)}
      {...props}
    />
  )
}
