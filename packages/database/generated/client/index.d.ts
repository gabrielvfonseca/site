...
export namespace Prisma {
  ...
  export type RequiredKeys<T> = {
    [K in keyof T]-?: {} extends PrismaPick<T, K> ? never : K;
  }[keyof T];
  ...
  export type TrueKeys<T> = TruthyKeys<PrismaPick<T, RequiredKeys<T>>>;
  ...
  */
   ...
   * ProjectsCountOutputType without action
   */
  export type ProjectsCountOutputTypeCountTagsArgs<
    _ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    where?: TagWhereInput;
  };
   ...
   */
  export type PostsCountOutputTypeDefaultArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
   ...
   * PostsCountOutputType without action
   */
  export type PostsCountOutputTypeCountTagsArgs<
    _ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    where?: TagWhereInput;
  };
  ...
  type ProjectsGetPayload<
    S extends boolean | null | undefined | ProjectsDefaultArgs,
  > = $Result.GetResult<Prisma.$ProjectsPayload, S>;
  ...
  > {
    ...
    updateManyAndReturn<T extends ProjectsUpdateManyAndReturnArgs>(
      args: SelectSubset<T, ProjectsUpdateManyAndReturnArgs<ExtArgs>>
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$ProjectsPayload<ExtArgs>,
        T,
    ...
    aggregate<T extends ProjectsAggregateArgs>(
      args: Subset<T, ProjectsAggregateArgs>
    ...
    >(
      args: SubsetIntersection<T, ProjectsGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors
  ...
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: 'PrismaPromise';
    tags<T extends Projects$tagsArgs<ExtArgs> = {}>(
      args?: Subset<T, Projects$tagsArgs<ExtArgs>>
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
          Prisma.$TagPayload<ExtArgs>,
          T,
  ...
  > = {
    ...
    data: Xor<
      ...
      ProjectsUncheckedUpdateManyInput
    >;
    /**
  ...
  > = {
    where?: PostsWhereInput;
    orderBy?:
      | PostsOrderByWithAggregationInput
      | PostsOrderByWithAggregationInput[];
  ...
  type GetPostsGroupByPayload<T extends PostsGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
  ...
  export type PostsSelectCreateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetSelect<
    {
      id?: boolean;
  ...
  export type PostsSelectUpdateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetSelect<
    {
      id?: boolean;
  ...
  export type PostsIncludeCreateManyAndReturn<
    _ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {};
  export type PostsIncludeUpdateManyAndReturn<
    _ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {};
  ...
  type PostsGetPayload<
    S extends boolean | null | undefined | PostsDefaultArgs,
  > = $Result.GetResult<Prisma.$PostsPayload, S>;
  ...
  > {
     ...
     * })
     */
    findUnique<T extends PostsFindUniqueArgs>(
     ...
     * })
     */
    findFirst<T extends PostsFindFirstArgs>(
     ...
     *
     */
    createManyAndReturn<T extends PostsCreateManyAndReturnArgs>(
     ...
     *
     */
    updateManyAndReturn<T extends PostsUpdateManyAndReturnArgs>(
      args: SelectSubset<T, PostsUpdateManyAndReturnArgs<ExtArgs>>
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$PostsPayload<ExtArgs>,
        T,
     ...
     * })
     **/
    aggregate<T extends PostsAggregateArgs>(
      args: Subset<T, PostsAggregateArgs>
    ): Prisma.PrismaPromise<GetPostsAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, PostsGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors
      ? GetPostsGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
    /**
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export interface Prisma__PostsClient<
    T,
    Null = never,
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    GlobalOmitOptions = {},
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: 'PrismaPromise';
    tags<T extends Posts$tagsArgs<ExtArgs> = {}>(
      args?: Subset<T, Posts$tagsArgs<ExtArgs>>
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
          Prisma.$TagPayload<ExtArgs>,
          T,
   ...
   */
  export type PostsCreateManyAndReturnArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Posts
   ...
   */
  export type PostsUpdateManyAndReturnArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Posts
  ...
  export type PostsScalarFieldEnum =
    (typeof PostsScalarFieldEnum)[keyof typeof PostsScalarFieldEnum];
  ...
  export type PostsScalarWhereWithAggregatesInput = {
    ...
    metaDescription?:
      | StringNullableWithAggregatesFilter<'Posts'>
      | string
      | null;
  ...
  export type PostsCreateNestedManyWithoutTagsInput = {
    create?:
      | Xor<PostsCreateWithoutTagsInput, PostsUncheckedCreateWithoutTagsInput>
      | PostsCreateWithoutTagsInput[]
      | PostsUncheckedCreateWithoutTagsInput[];
    connectOrCreate?:
      | PostsCreateOrConnectWithoutTagsInput
      | PostsCreateOrConnectWithoutTagsInput[];
  ...
  export type ProjectsCreateNestedManyWithoutTagsInput = {
    create?:
      | Xor<
          ProjectsCreateWithoutTagsInput,
          ProjectsUncheckedCreateWithoutTagsInput
        >
      | ProjectsCreateWithoutTagsInput[]
      | ProjectsUncheckedCreateWithoutTagsInput[];
    connectOrCreate?:
      | ProjectsCreateOrConnectWithoutTagsInput
      | ProjectsCreateOrConnectWithoutTagsInput[];
  ...
  export type PostsUpdateManyWithoutTagsNestedInput = {
    ...
    connectOrCreate?:
      ...
      | PostsCreateOrConnectWithoutTagsInput[];
    upsert?:
      | PostsUpsertWithWhereUniqueWithoutTagsInput
      | PostsUpsertWithWhereUniqueWithoutTagsInput[];
    ...
    connect?: PostsWhereUniqueInput | PostsWhereUniqueInput[];
    update?:
      | PostsUpdateWithWhereUniqueWithoutTagsInput
      | PostsUpdateWithWhereUniqueWithoutTagsInput[];
    updateMany?:
      | PostsUpdateManyWithWhereWithoutTagsInput
      | PostsUpdateManyWithWhereWithoutTagsInput[];
  ...
  export type ProjectsUpdateManyWithoutTagsNestedInput = {
    ...
    connectOrCreate?:
      ...
      | ProjectsCreateOrConnectWithoutTagsInput[];
    upsert?:
      | ProjectsUpsertWithWhereUniqueWithoutTagsInput
      | ProjectsUpsertWithWhereUniqueWithoutTagsInput[];
    ...
    connect?: ProjectsWhereUniqueInput | ProjectsWhereUniqueInput[];
    update?:
      | ProjectsUpdateWithWhereUniqueWithoutTagsInput
      | ProjectsUpdateWithWhereUniqueWithoutTagsInput[];
    updateMany?:
      | ProjectsUpdateManyWithWhereWithoutTagsInput
      | ProjectsUpdateManyWithWhereWithoutTagsInput[];
  ...
  export type PostsUpsertWithWhereUniqueWithoutTagsInput = {
    where: PostsWhereUniqueInput;
    update: Xor<
      PostsUpdateWithoutTagsInput,
      PostsUncheckedUpdateWithoutTagsInput
    >;
    create: Xor<
      PostsCreateWithoutTagsInput,
      PostsUncheckedCreateWithoutTagsInput
  ...
  export type PostsUpdateManyWithWhereWithoutTagsInput = {
    ...
    data: Xor<
      PostsUpdateManyMutationInput,
      PostsUncheckedUpdateManyWithoutTagsInput
    >;
  };
  ...
  export type ProjectsUpsertWithWhereUniqueWithoutTagsInput = {
    where: ProjectsWhereUniqueInput;
    update: Xor<
      ProjectsUpdateWithoutTagsInput,
      ProjectsUncheckedUpdateWithoutTagsInput
    >;
    create: Xor<
      ProjectsCreateWithoutTagsInput,
      ProjectsUncheckedCreateWithoutTagsInput
  ...
  export type ProjectsUpdateManyWithWhereWithoutTagsInput = {
    ...
    data: Xor<
      ProjectsUpdateManyMutationInput,
      ProjectsUncheckedUpdateManyWithoutTagsInput
    >;
  };
