...
export function LatestPost({ post }: LatestPostProps) {
	...
	return (
		<Link
			className="group flex flex-col gap-3 rounded-lg border border-border bg-muted/50 p-4 transition-colors duration-200 hover:border-foreground/25 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring"
			href={post.url}
