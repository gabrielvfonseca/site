...
export function Newsletter({
	...
	return (
		<aside
			className={cn(
				"not-prose my-8 flex flex-col gap-4 rounded-lg border border-border bg-muted/50 p-6 sm:flex-row sm:items-center sm:justify-between",
				className,
			)}
		>
			...
			<Link
				className="group inline-flex shrink-0 items-center gap-1.5 rounded-md border border-border bg-background px-4 py-2 text-foreground text-sm no-underline transition-colors hover:border-foreground/25 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring"
				href={href}
