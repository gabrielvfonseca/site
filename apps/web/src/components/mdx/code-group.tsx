...
export function CodeGroup({ children, className }: CodeGroupProps) {
	...
	return (
		<div className="not-prose my-6 overflow-hidden rounded-lg border border-border bg-muted/50">
				...
				<div className="flex" role="tablist">
					{panels.map((panel, index) => (
						<button
							...
							className={cn(
								"border-transparent border-b-2 px-4 py-2 font-mono text-muted-foreground text-xs transition-colors hover:text-foreground",
