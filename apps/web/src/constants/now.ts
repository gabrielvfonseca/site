...
export const NOW_SECTIONS: readonly NowSection[] = [
	...
	},
	{
		...
		items: [
			...
			{
				label: "Weekend crate-digging",
				detail: "Finding new records and samples to mix into the next set.",
			},
		],
	},
	{
		...
		items: [
			{
				...
				detail:
					"Lately I have been mixing deep house and melodic techno — digging for tracks with warm basslines and subtle progression.",
			},
			{
				label: "Practising transitions",
				detail:
					"Working on smoother key-matched blends and building longer, narrative sets rather than just track-to-track.",
			},
			{
				label: "Recording mixes",
				detail:
					"Capturing practice sets and sharing them privately to get feedback on pacing and flow.",
			},
		],
	},
	{
		...
		items: [
			...
			{
				label: "Record digging",
				detail:
					"Vinyl shops, Discogs rabbit holes, and finding that one track that ties a whole set together.",
			},
		],
	},
];
