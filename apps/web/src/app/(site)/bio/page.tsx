		...
		<div className="flex flex-col gap-12">
			...
			>
				...
				<p>
					...
					is a constant too: I play guitar and sometimes DJ when I need to step
					away from the screen. I&apos;m drawn to good design in every form
					including typography, product, and cities. I take a lot of inspiration
					from things that are built to last. I believe in building in public
					and sharing the journey along the way.
				</p>
				<p>
