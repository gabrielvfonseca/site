...
import { NOW_INTRO, NOW_LOCATION, NOW_SECTIONS, NOW_UPDATED } from "@/data/now";
 ...
 * `@/data/now`, so it's easy to keep current.
		...
		<div className="flex flex-col gap-12">
			...
			>
				<div className="flex flex-col gap-1">
					<h1 className="text-lg" id="now-intro-heading">
						Now
					</h1>
			...
			>
				<div className="flex flex-col gap-1">
					<h2 className="text-lg" id="now-map-heading">
						Around Lisbon
					</h2>
					<p className="text-muted-foreground text-sm">
			...
			{NOW_SECTIONS.map((section, index) => {
				...
				return (
					<section
						...
						key={section.title}
					>
						<h2 className="text-lg" id={headingId}>
							{section.title}
						</h2>
			...
			<section
				...
				className="flex scroll-mt-8 flex-col gap-4"
			>
				<h2 className="text-lg" id="now-about-heading">
					About this page
				</h2>
