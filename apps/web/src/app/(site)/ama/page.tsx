 ...
 */
async function AnsweredQuestions() {
	// Opt this boundary out of prerendering: the answers must reflect the live
	// database at request time, not whatever existed at build time.
	await connection();
...
export default function Page() {
	return (
		<div className="flex flex-col gap-12">
			...
			>
				<h1 className="text-lg" id="ama-intro-heading">
					Ask me anything
				</h1>
			...
			<section
				...
				className="flex scroll-mt-8 flex-col gap-4"
			>
				<h2 className="text-lg" id="ama-answers-heading">
					Answered
				</h2>
			...
			<section
				...
				className="flex scroll-mt-8 flex-col gap-4"
			>
				<h2 className="text-lg" id="ama-ask-heading">
					Ask a question
				</h2>
				<AmaForm />
			</section>
