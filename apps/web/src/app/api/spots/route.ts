...
import { SPOTS, type Spot, type SpotCategory } from "@/data/spots";
 ...
 * `@/data/spots` is returned, so the map always renders something.
 */

/** Shape returned to the client — matches `@/data/spots`'s `Spot`. */
