...
const components = {
  ...
  pre: (props: ComponentPropsWithoutRef<'pre'>) => (
    <pre
      className="mt-4 overflow-x-auto rounded-lg border border-accent-2 bg-accent-1 p-4 font-mono text-sm"
      {...props}
    />
  ),
  code: async ({ children, ...props }: ComponentPropsWithoutRef<'code'>) => {
    ...
    return (
      <code
        className="flex rounded-lg border border-accent-2 bg-accent-1 px-1 py-0.5 text-secondary"
