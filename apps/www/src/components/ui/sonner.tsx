...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast: 'group toast group-[.toaster]:bg-gray-200 dark:group-[.toaster]:bg-gray-1200 group-[.toaster]:text-black dark:group-[.toaster]:text-white group-[.toaster]:border-gray-400 dark:group-[.toaster]:border-gray-1000 group-[.toaster]:shadow-lg',
